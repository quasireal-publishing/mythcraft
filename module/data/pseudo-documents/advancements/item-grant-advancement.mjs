...
export default class ItemGrantAdvancement extends BaseAdvancement {
  ...
  /** @inheritdoc */
  static LOCALIZATION_PREFIXES = super.LOCALIZATION_PREFIXES.concat("MYTHCRAFT.Advancement.ITEM_GRANT");
   ...
   * @type {Set<string>}
   */
  static ALLOWED_TYPES = new Set(["armor", "feature", "gear", "talent", "weapon"]);
  ...
  prepareBaseData() {
    ...
    const hasDefaultImage = (this.img === mythcraft.CONFIG.Advancement.itemGrant.defaultImage);
