...
export default class BaseAdvancement extends TypedPseudoDocument {
  ...
  /** @inheritdoc */
  static LOCALIZATION_PREFIXES = super.LOCALIZATION_PREFIXES.concat("MYTHCRAFT.Advancement");

  /* -------------------------------------------------- */

  /** @inheritdoc */
  static CREATE_TEMPLATE = systemPath("templates/advancement/create-dialog.hbs");
