...
export default class AdvancementModel extends BaseItemModel {
  ...
  /** @inheritdoc */
  static LOCALIZATION_PREFIXES = super.LOCALIZATION_PREFIXES.concat("MYTHCRAFT.Item.advancement");
   ...
   * @param {MythCraftActor} [options.actor]    The actor to create this item within.
