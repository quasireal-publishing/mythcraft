...
export default class CollectionField extends TypedObjectField {
  ...
  constructor(model, options = {}, context = {}) {
    let field = foundry.utils.isSubclass(model, mythcraft.data.pseudoDocuments.TypedPseudoDocument)
  ...
  initialize(value, model, options = {}) {
    ...
    for (const [id, model] of Object.entries(init)) {
      if (model instanceof mythcraft.data.pseudoDocuments.PseudoDocument) {
